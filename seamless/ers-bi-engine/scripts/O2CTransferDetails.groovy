...
@Component("O2CTransferDetails")
public class O2CTransferDetails extends IReportScriptBaseService implements IReportScriptService {
    org.apache.log4j.Logger log = Logger.getLogger("O2CTransferDetails");
    @Autowired
