		...
		try
		{
			...
			if (outgoingResponse != null)
			{
				...
				if (outgoingResponse instanceof Exception)
				{
					...
					response.put(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TXNSTATUS, StandardLinkResultCodes.INTERNAL_COMPONENT_ERROR);
				...
				if (!internalResponse.isEmpty() && internalResponse.containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Txe.RESULT_CODE))
				{
					...
					if (resultCodeValue == StandardLinkResultCodes.SUCCESS)
					{
						...
						response.put(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TXNSTATUS, resultCode.getInternalResultCode());
						...
						if (responseMap.get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.LIST) != null)
						{
							...
							for (int i = 0; i < transactions.size(); i++)
							{
								...
								if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTCODE) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTCODE) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTCODE).toString()))
								{
	                                                          response.put(Constants.Gp.REQSTATUS, resultCode.getInternalResultCode());
									// response.put(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.REQSTATUS, transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTCODE).toString());
								}
								else
								{
								...
								if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTSTATUS) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTSTATUS) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.RESULTSTATUS).toString()))
								{
									...
									if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TIMESTAMP) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TIMESTAMP) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TIMESTAMP).toString()))
									{
									...
									if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SENDERMSISDN2) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SENDERMSISDN2) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SENDERMSISDN).toString()))
									{
									...
									if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SERVICE_TYPE) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SERVICE_TYPE) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.SERVICE_TYPE).toString()))
									{
									...
									if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.PRODUCTSKU) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.PRODUCTSKU) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.PRODUCTSKU).toString()))
									{
									...
									if (transactions.get(i).containsKey(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TRANSACTIONAMOUNT) && Objects.nonNull(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TRANSACTIONAMOUNT) && !StringUtils.isEmpty(transactions.get(i).get(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TRANSACTIONAMOUNT).toString()))
									{
				...
				else
				{
					...
					response.put(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.TXNSTATUS, StandardLinkResultCodes.FAILED_ON_SERVER);
					response.put(com.seamless.ers.standardlink.transformers.C2STransferStatusTransformer.Constants.Gp.REQSTATUS, StandardLinkResultCodes.FAILED_ON_SERVER);
				}
				return response;
			}
		}
