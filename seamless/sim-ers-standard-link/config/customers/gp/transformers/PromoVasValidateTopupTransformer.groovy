...
@Component
public class PromoVasValidateTopupTransformer implements ERSIOTransformer
{
	private static final Logger LOGGER = LoggerFactory.getLogger(PromoVasValidateTopupTransformer.class);
